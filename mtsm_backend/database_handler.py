import sqlite3
from mtsm_backend.sql_queries import (CREATE_FINGERPRINTS_TABLE, CREATE_FINGERPRINTS_TABLE_SOUNDTRACK, CREATE_SOUNDTRACK_TABLE, INSERT_FINGERPRINT,CREATE_INDEX,SELECT_FINGERPRINT,
